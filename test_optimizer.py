...
class TestOptimiser(unittest.TestCase):
    ...
    def test_breed(self):
        network1 = {'nb_neurons': 1024, 'nb_layers': 1, 'activation': 'relu', 'optimizer': 'sgd'}
        network2 = {'nb_neurons': 64, 'nb_layers': 3, 'activation': 'tanh', 'optimizer': 'adagrad'}
        offspring = self.optimizer.breed(network1, network2)
        ...
        self.assertNotEqual(offspring[0], network1, "Offspring still the same as parent.")
